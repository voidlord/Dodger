...
Shader::Shader(const char* vertexSourcePath, const char* fragmentSourcePath) {
	...
	try {
		vShaderSourceFile.open(vertexSourcePath);
		fShaderSourceFile.open(fragmentSourcePath);

		std::stringstream vShaderStream, fShaderStream;

		vShaderStream << vShaderSourceFile.rdbuf();
		fShaderStream << fShaderSourceFile.rdbuf();
